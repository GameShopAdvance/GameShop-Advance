...
public class ChartPanel extends JPanel {
    ...
    private void reserveActionPerformed(ActionEvent e) {
        try {
            ...
            CompletedReservationPanel panel = new CompletedReservationPanel();
            panel.setID(ReservationControllerSingleton.getInstance().getID());
            panel.setTotal(ReservationControllerSingleton.getInstance().getTotal());
            panel.setPartial(ReservationControllerSingleton.getInstance().getPartial());
            this.listener.pushPanel(panel);
        }
    ...
    private void initComponents() {
        ...
        PanelBuilder builder = new PanelBuilder(new FormLayout(
            ...
            "[15dlu,default], $lgap, [20dlu,default], $lgap, default:grow, 2*($lgap, [20dlu,default]), $lgap, 15dlu"), this);

        builder.add(this.label2,      CC.xywh(3, 3,       7,       1, CC.CENTER , CC.FILL));
        builder.add(this.scrollPane1, CC.xywh(3, 5,       7,       1, CC.FILL   , CC.FILL));
        builder.add(this.label1,      CC.xywh(3, 7,       5,       1, CC.DEFAULT, CC.FILL));
        builder.add(this.totale,      CC.xy  (9, 7, CC.FILL, CC.FILL));
        builder.add(this.back,        CC.xy  (3, 9, CC.FILL, CC.FILL));
        builder.add(this.button2,     CC.xy  (7, 9, CC.FILL, CC.FILL));
        builder.add(this.button1,     CC.xy  (9, 9, CC.FILL, CC.FILL));
