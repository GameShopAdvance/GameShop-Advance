...
public class PaymentPanel extends JPanel implements IListPanel {
    ...
    private void initComponents() {
        ...
        PanelBuilder builder = new PanelBuilder(new FormLayout(
            "$rgap, [350px,min,600dlu]:grow, $lcgap, [146px,min], $lcgap, [25dlu,default], $lcgap, [75dlu,default], $rgap",
            "2*($rgap, [35dlu,default]), $rgap, fill:[35dlu,default], $lgap, [35dlu,default]:grow, $rgap"), this);

        builder.add(scrollPane1,  CC.xywh(2, 2,       1,       7));
        builder.add(label1,       CC.xy  (4, 2, CC.FILL, CC.FILL));
        builder.add(displayTotal, CC.xywh(6, 2,       3,       1, CC.FILL, CC.FILL));
        builder.add(payment,      CC.xywh(6, 4,       3,       1, CC.FILL, CC.FILL));
        builder.add(label2,       CC.xy  (4, 4, CC.FILL, CC.FILL));
        builder.add(payButton,    CC.xy  (8, 6));
