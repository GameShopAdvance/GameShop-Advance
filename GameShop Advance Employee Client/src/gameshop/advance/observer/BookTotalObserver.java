 ...
 * @author Salx
 */
public class BookTotalObserver extends UnicastRemoteObject implements IRemoteObserver {
 
    private IRemoteClient client;
    
    public BookTotalObserver(IRemoteClient client) throws RemoteException {
        this.client = client;
    }
    ...
    public void notifica(Object o) throws RemoteException{
        ...
        this.client.aggiornaTotale(prenotazione.getTotal());
    }
}
